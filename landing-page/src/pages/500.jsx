...
export default function Login() {
	return (
		<>
			<Head>
				<title>Server error - Sheet2GraphQL</title>
			...
			<main className="flex overflow-hidden pt-16 sm:py-28 mb-28">
				<div className="mx-auto flex w-full max-w-2xl flex-col px-4 sm:px-6">
					...
					<div className="-mx-4 mt-10 bg-white py-10 px-4 shadow-2xl shadow-gray-900/10 sm:mx-0 sm:flex-none sm:rounded-2xl sm:p-16">
						...
						<h1 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Server error</h1>
						<p className="mt-2 text-base text-gray-500">Sorry, we are unable to process your request at the moment, please try again later.</p>
					</div>
				</div>
			</main>
			<Footer />
